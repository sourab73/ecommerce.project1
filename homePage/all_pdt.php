				...
				<div class="col">
					<div class="tabbed_container">
						<div class="tabs clearfix tabs-right">
							...
							<ul class="clearfix">
								<li>End In</li>
								<li><div class="deals_timer_content ml-auto">
...
<?php
 ...
 @$sql="select * from product_information where catagory_name='".$_GET["catName"]."'";
...
?>
	...
	<div class="col-lg-2 col-md-6 col-sm-6 col-xs-6 mb-1" style="max-width: 50%;">
	    <a href="product.php?moreId=<?php echo $fetch[2];?>" style="text-decoration: none; color:black">
	      <div class="card" style="height: 100%" > 
	        <img class="card-img-top" id="zoom" src="../productImage/<?php echo $fetch[2];?>.jpg" alt="Card image" style="height: 150px; width: 100%;">
	        <div class="card-body">
	          <h6 class="card-title"><?php echo $fetch[3];?></h6>

	          <p class="card-text" style="color:#F88824">৳ <?php echo $fetch[5];?> <!-- &nbsp<del style="color:#ccc" >-৳13000</del> --></p>
